...
for i in $(seq 1 5); do
    ...
    dline_py=$(diff pt_output_${i}.txt correct_ans_win/golden_${i}.txt |  wc | awk -F ' ' '{print $1}')
    if [ "${dline_py}" == "0" ] && [ -f pt_output_${i}.txt ] && [ -f correct_ans_win/golden_${i}.txt ] ; then
...
for i in $(seq 1 5); do
    ...
    dline_py=$(diff dp_output_${i}.txt correct_ans_win/golden_${i}.txt |  wc | awk -F ' ' '{print $1}')
    if [ "${dline_py}" == "0" ] && [ -f dp_output_${i}.txt ] && [ -f correct_ans_win/golden_${i}.txt ] ; then
...
for i in $(seq 1 5); do
    ...
    dline_py=$(diff sy_output_${i}.txt correct_ans_win/golden_${i}.txt |  wc | awk -F ' ' '{print $1}')
    if [ "${dline_py}" == "0" ] && [ -f sy_output_${i}.txt ] && [ -f correct_ans_win/golden_${i}.txt ] ; then
